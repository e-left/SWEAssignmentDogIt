...
/**
 * Delete own DogTab by ID
 * FR2 - The logged-in user must be able edit the dog tabs they already created.  <br>
 *
 * dogTabID Long Dog tab's ID to delete
 * no response value expected for this operation
 **/
exports.dogtabsOwnDogTabIDDELETE = function(dogTabID) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
...
/**
 * Edit own DogTab by ID
 * FR2 - The logged-in user must be able edit the dog tabs they already created. <br>
 *
 * body DogTabsEdit Information needed to edit a DogTab
 * dogTabID Long Dog tab's ID to edit
 * no response value expected for this operation
 **/
exports.dogtabsOwnDogTabIDPUT = function(body,dogTabID) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
...
/**
 * View all personal/own DogTabs
 * FR2 - The logged-in user must be able edit the dog tabs they already created.  <br> FR3 - The logged-in user must be able to see all the posted dog tabs. <br>
 *
 * returns List
 **/
exports.dogtabsOwnGET = function() {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "sex" : "Male",
